    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Order Placed', 'Order Placed'), ('delivered', 'delivered'), ('out for delivery', 'out for delivery'), ('shipped', 'shipped'), ('cancelled', 'cancelled')], default='Order Placed', max_length=100)),
